...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 25 avr. 2020 à 11:37
...
CREATE TABLE IF NOT EXISTS `contient` (
  ...
  PRIMARY KEY (`idI`,`idR`,`idC`) USING BTREE,
  KEY `idR_idx` (`idR`),
  KEY `idC_idx` (`idC`)
...
INSERT INTO `contient` (`idC`, `idI`, `idR`, `quantite`, `unite`, `category`) VALUES
(1, 13, 12, 1, 'L', NULL),
(2, 14, 12, 10, 'G', NULL),
(3, 15, 12, 10, 'G', NULL),
(6, 17, 13, 3, 'Feuille', NULL),
(7, 18, 13, 1, 'Cm', NULL),
(11, 18, 14, 1, 'Gousse', 'Sauce'),
(5, 19, 13, 3, 'Cs', NULL),
(4, 20, 13, 600, 'Ml', NULL),
(12, 22, 14, 0.5, 'Gousse', 'Sauce'),
(10, 24, 14, 0.5, 'Botte', 'Sauce'),
(13, 26, 14, 2, 'Cs', 'Sauce'),
(14, 27, 14, 1, 'Pincée', 'Sauce'),
(16, 28, 14, 0.25, '', 'Sauce'),
(15, 29, 14, 100, 'Ml', 'Sauce'),
(8, 30, 14, 12, '', NULL),
(9, 31, 14, 1, 'Pincée', NULL);
...
(36, 'Mirin', NULL),
(37, 'Sake', NULL),
(38, 'Vin de riz shaoxing', NULL),
(39, 'Vinaigre de vin', NULL),
(40, 'Huile d\'olive', NULL),
(41, 'Pomme', NULL),
(42, 'Poire', NULL),
(43, 'Pamplemousse', NULL),
(44, 'Lardon', NULL),
(45, 'Marron glacé', NULL),
(46, 'Pêche', NULL),
(47, 'Lait', NULL),
(48, 'Chocolat au lait', NULL);
...
(15, 'Test', '01:00:00', '01:00:00', 1, 'Personne', 'Oui', 'Oui', 0, 0, 2, NULL, '2019-09-01 11:56:25');
