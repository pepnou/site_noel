		...
		?>
			...
			<html>
				...
				<body onload="getResultsR();">
					...
					<a href="/site_noel/cuisine/insert/insert.php" style="width: 20%; margin-bottom: 10px;"><h2>Insertion</h2></a>
							...
							<fieldset>
								...
								<fieldset>
									...
									<fieldset>
										...
										<div style="flex-direction: row; flex-wrap: wrap; width: initial;">
											<?php
												$sql = 'SELECT * FROM tag';
