						...
						<div id="Filtres" style="width: min-content;">
							<fieldset>
								...
								<fieldset>
									...
									<div>
										<div>
											<input type="text" name="nom" id="nom" autocomplete="off" value="<?php echo $recette[1]; ?>">
								...
								<fieldset>
									...
									<fieldset>
										...
										<div>
											<div>
												<input type="text" name="pays" id="pays" value="<?php echo $recette[7]; ?>">
												<label for="pays">Pays</label>
											</div>
											<div>
												<input type="text" name="source" id="source" value="<?php echo $recette[6]; ?>">
